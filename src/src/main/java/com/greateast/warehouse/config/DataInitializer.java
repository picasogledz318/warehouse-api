...
import com.greateast.warehouse.model.Item;
import com.greateast.warehouse.model.Variant;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        v1.setColor("Red");
        v1.setSize("M");
        v1.setPrice(new BigDecimal("99.99"));
        v1.setStock(10);
        ...
        v2.setColor("Blue");
        v2.setSize("L");
        v2.setPrice(new BigDecimal("109.99"));
        v2.setStock(5);
