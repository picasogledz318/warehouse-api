...
public class LoggingAspect {
    ...
    //Calculate any process from any method executed
    @Around("@annotation(com.greateast.warehouse.util.logresponsetime.LogExecutionTime)")
    public Object methodTimeLogger(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        StopWatchExtension stopWatchExtension = new StopWatchExtension();
        ...
        if (logger.isInfoEnabled()) {
            logger.info(stopWatchExtension.prettyPrintInMilliseconds(stopWatch));
        }
        return result;
    }
}
