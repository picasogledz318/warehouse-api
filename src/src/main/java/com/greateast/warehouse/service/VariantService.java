...
public class VariantService {
     ...
     */
    public BaseResponseDto<Variant> save(Variant variant) {
    ...
    public BaseResponseDto<Variant> update(long id,  Variant variant) {
        BaseResponseDto<Variant> resp = new BaseResponseDto<>();
        ...
        try{
            ...
            if(existingVariant != null){
                variant.setId(existingVariant.getId());
                resp.setCode(TrxCode.TRX_OK.code());
                resp.setData(save(variant).getData());
                resp.setErrors(null);
    ...
    public BaseResponseDto<?> deleteById(long id) {
        ...
        try{
            if(isVariantExist){
                ...
                resp.setData(null);
                resp.setErrors(null);
                resp.setMessage("Variant id "+id+" successfully deleted!");
