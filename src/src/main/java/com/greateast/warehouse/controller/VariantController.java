...
public class VariantController {
    ...
    @PostMapping("/create")
    @LogExecutionTime
    public ResponseEntity<BaseResponseDto<Variant>> createVariant(@RequestBody Variant Variant) throws Exception{
    ...
    public ResponseEntity<BaseResponseDto<Variant>> updateVariant(@PathVariable("id") long id, @RequestBody Variant Variant) {
